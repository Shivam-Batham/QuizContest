...
//=======================================timer
  ...
  return (
    <header className="fixed transition ease-in-out delay-100 sm:h-[100px] h-[80px] min-w-[360px] break-words sm:min-w-[100%] sm:p-2  pb-2 bg-slate-950 shadow-neutral-200 ">
      <nav className=" grid sm:grid-cols-2 grid-cols-6  gap-5 ">
        <div className="sm:col-span-1 col-span-3 ">
          <h1 className=" pl-2 sm:text-5xl text-4xl text-start   font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sky-200 to-sky-500">
          Instant Quiz
          </h1>
        </div>

        <div className="sm:col-span-1 text-end pr-2  col-span-3">
         
           
           {(url.pathname =="/contest") || (url.pathname =="/contest/")?  <h1 className="break-words sm:text-4xl text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-green-500">
