...
//=======================================timer
  ...
  return (
    <header className="fixed transition ease-in-out delay-100 sm:h-[100px] h-[80px] w-[360px] break-words sm:min-w-[100%] sm:p-2  pb-2 bg-slate-950 shadow-neutral-200 ">
