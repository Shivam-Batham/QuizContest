...
function Footer() {
  return (
    <footer className="break-words sm:min-h-[300px] w-[380px]  sm:min-w-[100%] Sm:p-10  bg-slate-950 shadow-lg">
      {/* container */}
      <div className="grid sm:grid-cols-12 grid-cols-2 sm:gap-2 gap-4 p-2 ">
        {/* company details */}

        <div className=" sm:col-span-6 col-span-1   overflow-auto ">
          <p className=" sm:text-5xl text-4xl sm:text-start   font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-sky-600">
            Instant Quiz
          </p>
          
            <p className=" sm:text-xl  text-l text-start   font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sky-200 to-sky-500">
        ...
        <div className="sm:col-span-6 col-span-1 ">
          <h3 className="sm:text-5xl text-4xl text-start   font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-green-500">
            Social Pages
          </h3>
          <Link
            className="block sm:text-xl text-l  text-start   font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-200 to-green-500"
